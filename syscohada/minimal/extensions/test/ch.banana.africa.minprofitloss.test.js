...
MinimalProfitLossReport.prototype.testBananaExtension = function() {
	 ...
	 * Test 1: column Gr
	 */
	var banDoc = Banana.application.openDocument("file:script/../test/testcases/ETS_DIENA_2024.ac2");
    var previousDoc = Banana.application.openDocument("file:script/../test/testcases/ETS_DIENA_2023.ac2");
	Test.assert(banDoc);
